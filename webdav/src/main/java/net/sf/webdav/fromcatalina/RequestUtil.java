...
public final class RequestUtil {
     ...
     */
    public static String encodeCookie(JapHttpCookie cookie) {
     ...
     */
    public static JapHttpCookie[] parseCookieHeader(String header) {

        if ((header == null) || (header.length() < 1))
            return (new JapHttpCookie[0]);

        ArrayList<JapHttpCookie> cookies = new ArrayList<>();
        while (header.length() > 0) {
            ...
            try {
                ...
                if (equals > 0) {
                    ...
                    cookies.add(new JapHttpCookie(name, value));
                }
            } catch (Throwable e) {
                ;
            }
        ...
        return ((JapHttpCookie[]) cookies.toArray(new JapHttpCookie[cookies.size()]));
